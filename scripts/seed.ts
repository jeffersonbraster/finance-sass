...
const SEED_USER_ID = "user_2g4jKqHSkuuao9elQldDDcS11fD";
...
import { convertAmountToMiliunits, convertAmountToMiliunitsNumber } from "@/lib/utils";
...
const generateTransactionsForDay = (day: Date) => {
  ...
  for (let i = 0; i < numTransactions; i++) {
    ...
    const formattedAmount = convertAmountToMiliunitsNumber(isExpense ? -amount : amount); // Negative for expenses
